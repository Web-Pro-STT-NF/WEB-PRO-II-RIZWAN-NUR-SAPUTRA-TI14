  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block">Rizwan Nur Saputra</a>
        </div>
      </div>
     ...
     <div class='container'>
                <form class='form-horizontal p-5' action="halamanBMI.php" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="number" class="form-control" id="inputPassword3" name='berat_' placeholder="kg">
                        </div>
                    </div>
                    <!----> 
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input type="number" class="form-control" id="inputPassword3" name='tinggi_' placeholder="cm">
                        </div>
                    </div>
                    <!----->
                    <div class="form-group row">
